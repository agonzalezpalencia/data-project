...
def exercise4_metric_1():
    ex4_1_metric_1 = ex4.delivered_reviews_count_per_state()
    ex4_1_metric_2 = ex4.canceled_reviews_count_per_state()
...
def exercise4_metric2():
    ex4_2_metric_1 = ex4.delivered_mean_reviews_score_per_state()
    ex4_2_metric_2 = ex4.canceled_mean_reviews_score_per_state()
